...
const backupDir = path.join(process.cwd(), 'audio-backup', 'lesson4-examples')
...
// Lesson 4 grammar examples that need audio
const lesson4Examples = [
  {
    text: "Il est quinze heures trente.",
    category: "grammar",
    lessonId: "beginner-4",
    context: "Grammar example - telling time (3:30 PM)",
    keyWords: "quinze heures trente"
  },
  {
    text: "Nous sommes lundi, le trois janvier.",
    category: "grammar",
    lessonId: "beginner-4",
    context: "Grammar example - days and dates",
    keyWords: "lundi, le trois janvier"
  },
  {
    text: "J'ai rendez-vous à dix heures et demie.",
    category: "grammar",
    lessonId: "beginner-4",
    context: "Grammar example - appointments and time",
    keyWords: "dix heures et demie"
  },
  {
    text: "Quelle heure est-il? Il est midi.",
    category: "grammar",
    lessonId: "beginner-4",
    context: "Grammar example - asking and telling time",
    keyWords: "Quelle heure... midi"
  },
  {
    text: "Mon anniversaire est le vingt-cinq décembre.",
    category: "grammar",
    lessonId: "beginner-4",
    context: "Grammar example - dates and celebrations",
    keyWords: "le vingt-cinq décembre"
  },
  {
    text: "Le magasin ouvre à neuf heures du matin.",
    category: "grammar",
    lessonId: "beginner-4",
    context: "Grammar example - business hours and time",
    keyWords: "neuf heures du matin"
  }
]
...
// Main function to generate Lesson 4 examples audio
async function generateLesson4Examples() {
  console.log('🎵 Generating audio for Lesson 4 grammar examples...\n')
  console.log(`🎯 Target: ${lesson4Examples.length} examples using André's voice\n`)
  ...
  for (const example of lesson4Examples) {
    try {
  ...
  if (successCount > 0) {
    console.log(`\n🔊 Lesson 4 Examples should now have audio!`)
    console.log(`🎯 Test the Examples section in Lesson 4`)
  }
}

generateLesson4Examples()
