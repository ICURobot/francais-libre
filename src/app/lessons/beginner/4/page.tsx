      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-12 border border-gray-200 transform hover:scale-[1.005] hover:shadow-xl transition-all duration-300">
          ...
          {lesson.grammar.conjugation_table && (
            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-3">Time & Date Patterns:</h4>
              <div className="grid grid-cols-2 gap-3">
                {lesson.grammar.conjugation_table.map((conj, index) => (
                  <div key={index} className="bg-pink-50 p-3 rounded-lg text-center transform hover:scale-[1.02] hover:shadow-md transition-all duration-300 cursor-pointer">
