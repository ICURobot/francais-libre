  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl shadow-lg p-8 mb-6 border border-green-200">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-200 transform hover:scale-[1.005] hover:shadow-xl transition-all duration-300">
          ...
          <div className="space-y-4">
            {lesson.vocabulary.map((word, index) => (
              <div key={index} className="border-l-4 border-blue-500 bg-blue-50 p-4 rounded-lg transform hover:scale-[1.01] hover:shadow-md transition-all duration-300 cursor-pointer">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm bg-blue-200 text-blue-800 px-2 py-1 rounded-full">{word.category}</span>
                </div>
        ...
        <div className="flex justify-between items-center mt-12">
          <Link href="/lessons/beginner/4" className="bg-gray-600 text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition">
            ← Previous Lesson
          </Link>
