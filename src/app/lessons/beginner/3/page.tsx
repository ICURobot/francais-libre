  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl shadow-lg p-8 mb-6 border border-orange-200">
        ...
        <div className="flex justify-between items-center mt-12">
          <Link href="/lessons/beginner/2" className="bg-gray-600 text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition">
            ← Previous Lesson
          </Link>
